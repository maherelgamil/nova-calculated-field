...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-calculated-field', __webpack_require__(3));
  Vue.component('detail-nova-calculated-field', __webpack_require__(6));
  Vue.component('form-nova-calculated-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    calculateValue: function calculateValue(value) {
      ...
      Nova.request().post('/maherelgamil/nova-calculated-field/calculate/' + this.resourceName + '/' + this.field.attribute, {
        value: value
      }).then(function (response) {
        _this3.value = response.data.value;
  ...
  computed: {
    shouldRegisterInitialListener: function shouldRegisterInitialListener() {
